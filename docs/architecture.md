...
│   ├── Timeline/                          # Razor Class Library — диаграмма Ганта
│   │   ├── Components/                    # GanttChart, GanttTimeline
│   │   ├── Models/                        # GanttNode, CalendarDay, зависимости
│   │   ├── Services/                      # TimelineCalculator, WorkCalendar
│   │   └── wwwroot/                       # JS (скролл-синхронизация, observer)
...
|-------|-----------|-------------------|--------------------|
| 208-ФЗ (АО) | Автоматический контроль кворума ([ст. 68](laws/208-fz/article-68.md)) | Meeting → `QuorumService` | Реализовано |
...
| 14-ФЗ (ООО) | Контроль кворума ([ст. 32](laws/14-fz/article-14fz-32.md)) | Meeting → `QuorumService` | Реализовано |
