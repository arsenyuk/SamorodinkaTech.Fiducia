...
Право на выход участника из ООО определяется уставом. Индивидуальный устав может содержать следующие ограничения:
...
> **См. также:** [Настройка индивидуального устава ООО](custom-charter.md) — параметры выхода в системе Fiducia.
