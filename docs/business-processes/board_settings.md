...
**Правовое основание:** Избрание Совета директоров осуществляется на общем собрании акционеров в порядке, предусмотренном **п. 1, 3 ст. 66 Закона № 208-ФЗ** . Для публичных обществ и непубличных с числом акционеров более 1000 применяется **кумулятивное голосование (п. 4 ст. 66 Закона № 208-ФЗ)** .
...
- Решение принимается **большинством голосов от общего числа избранных членов** Совета, а не от числа присутствующих **(п. 2 ст. 66 Закона № 208-ФЗ)** .
- Председатель **не может быть** Генеральным директором или членом правления общества **(п. 2 ст. 66 Закона № 208-ФЗ)** .

**Результаты:**

- **Если Председатель избран:** В ИС фиксируется Ф.И.О. избранного, дата избрания и результаты голосования.
- **Если Председатель не избран:** В ИС фиксируются результаты голосования и причина (недостаток голосов). В этом случае Совет назначает исполняющего функции Председателя из числа членов СД до следующего заседания **(п. 3 ст. 67 Закона № 208-ФЗ)** .
...
|--------|-----------------|-------------------|
| Председатель избран | **Председатель СД** | п. 4 ст. 68 Закона № 208-ФЗ  |
| Председатель не избран, назначен исполняющий | **Исполняющий функции Председателя** | п. 3 ст. 67 Закона № 208-ФЗ  |
| Председатель отсутствует, есть Заместитель | **Заместитель Председателя** | п. 2, 3 ст. 67 Закона № 208-ФЗ  |
| Секретарь СД назначен | **Секретарь СД** (в дополнение к Председателю) | п. 4 ст. 68 Закона № 208-ФЗ, п. 11.4 Положения о СД  |
...
|----------|-------------------|
| Избрание СД на ОСА | п. 1, 3 ст. 66 Закона № 208-ФЗ  |
| Кумулятивное голосование | п. 4 ст. 66 Закона № 208-ФЗ  |
| Срок полномочий СД — до следующего ГОСА | п. 1 ст. 66 Закона № 208-ФЗ  |
| ГОСА — с 1 марта по 30 июня | п. 3 ст. 47 Закона № 208-ФЗ  |
| Протокол ОСА — не позднее 3 рабочих дней | п. 1 ст. 63 Закона № 208-ФЗ  |
| Избрание Председателя СД | п. 2 ст. 66 Закона № 208-ФЗ  |
| Председатель не может быть Генеральным директором | п. 2 ст. 66 Закона № 208-ФЗ  |
| При отсутствии Председателя — один из членов СД | п. 3 ст. 67 Закона № 208-ФЗ  |
| Кворум СД — не менее половины от числа избранных членов | п. 2 ст. 68 Закона № 208-ФЗ  |
| Протокол СД подписывается Председателем и Секретарем (если есть) | п. 4 ст. 68 Закона № 208-ФЗ  |
| Секретарь СД — не обязан, может быть назначен | п. 1 ст. 68 Закона № 208-ФЗ  |
