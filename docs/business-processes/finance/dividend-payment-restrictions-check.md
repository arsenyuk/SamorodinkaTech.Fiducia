...
>
> **Правовая основа:** [ст. 43 208-ФЗ](../laws/208-fz/article-43.md) — ограничения выплаты дивидендов.
>
...
Комплексная проверка всех условий [ст. 43 208-ФЗ](../laws/208-fz/article-43.md). Выполняется параллельно с работами П-2 — П-5. Результат — итоговое заключение для совета директоров.

**Ответственные:** финансовая служба + юристы.

### П-2. Проверка оплаты уставного капитала

Проверяется, что уставный капитал общества полностью оплачен. Выплата дивидендов **запрещена** до полной оплаты всего уставного капитала (п. 1 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md)).

**Источники данных:** устав, сведения из ЕГРЮЛ, внутренние регистры.

### П-3. Проверка чистых активов с учётом планируемой выплаты

Расчёт чистых активов (раздел I бухгалтерского баланса — итого по строке 1600 за вычетом строк 1400 и 1500). Проверяется два условия (п. 2 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md)):
...
| Норма | Содержание |
|-------|-----------|
| п. 1 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md) | Запрет выплаты до полной оплаты уставного капитала и выкупа акций |
| п. 2 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md) | Запрет выплаты при недостаточности чистых активов |
| п. 3 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md) | Запрет выплаты при признаках банкротства |
| п. 4 [ст. 43 208-ФЗ](../laws/208-fz/article-43.md) | Ответственность за нарушение порядка выплаты |
