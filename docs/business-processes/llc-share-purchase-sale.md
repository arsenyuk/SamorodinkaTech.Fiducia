...
flowchart TD
    ...
    E --> L["Доля стала казначейской"]
    B -->|"Продажа ООО разрешена"| F["Нотариальное удостоверение оферты"]
...
9. Общее собрание участников принимает решение о судьбе доли (продать, распределить или погасить) — единогласно.
10. Общество обязано в течение одного года реализовать принятое решение. При пропуске срока – риск судебного иска от бывшего участника.
