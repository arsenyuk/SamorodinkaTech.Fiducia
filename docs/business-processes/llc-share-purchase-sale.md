...
flowchart LR
    ...
    subgraph UC["Действия с долями"]
        U1["Удостоверить сделку купли-продажи доли"]
        U2["Удостоверить оферту о продаже доли"]
        U3["Удостоверить заявление о выходе участника"]
        U4["Удостоверить согласие супруга на продажу"]
        U5["Выдать выписку из реестра списков участников"]
        U6["Зарегистрировать изменения в ЕГРЮЛ"]
        U7["Проверить семейное положение продавца"]
    end
