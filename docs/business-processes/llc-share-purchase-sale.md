...
4. **Проверяет содержание согласия** — в нём должны быть указаны: данные супруга-продавца, данные супруга-соглашающегося, предмет согласия (конкретная доля в конкретном ООО). Размытые формулировки («согласен на любые сделки») не принимаются.
5. **Сверяет личность** супруга, выдавшего согласие, по паспорту — если он присутствует лично. Если согласие выдано другим нотариусом — проверяется подлинность нотариального акта.
...
flowchart TD
    ...
    L -->|Да| M["Проверка содержания согласия"]
    M --> N{Данные и предмет указаны конкретно?}
    N -->|"Нет (размыто, «на любые сделки»)"| R6["❌ Отказ в удостоверении: согласие ненадлежащее"]
    N -->|Да| O["Сверка личности супруга / подлинности акта"]
    O --> P{Личность / подлинность подтверждены?}
    P -->|Нет| R7["❌ Отказ в удостоверении: не подтверждена личность"]
    P -->|Да| CERT
...
7. Договор подлежит нотариальному удостоверению (если это не выход, а продажа).
8. Нотариус подаёт документы на регистрацию изменений в ЕГРЮЛ.
...
- Если участник пропустил 45-дневный срок для требования выкупа (при крупной сделке или увеличении уставного капитала) – общество освобождается от обязанности выкупа.
...
10. Договор обязательно удостоверяется нотариусом. Без нотариуса сделка ничтожна.
11. Нотариус проверяет оплату доли продавцом, отсутствие арестов/залогов, полномочия сторон, согласие супруга (если требуется).
12. При обнаружении проблем нотариус отказывает в удостоверении.
13. После удостоверения нотариус подаёт документы в ФНС для регистрации изменений в ЕГРЮЛ.
...
8. Договор обязательно удостоверяется нотариусом. Без нотариуса сделка ничтожна.
9. Нотариус проверяет: оплату доли продавцом, отсутствие арестов/залогов, полномочия сторон, согласие супруга (если доля – совместное имущество).
10. При выявлении проблем нотариус отказывает в удостоверении.
11. После удостоверения нотариус подаёт документы в ФНС для регистрации изменений в ЕГРЮЛ.
