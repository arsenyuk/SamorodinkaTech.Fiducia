...
- [Выплата дивидендов в АО через регистратора](../gantt/dividend-distribution-ao-gantt.md) — диаграмма Ганта процесса выплаты
- [Запрос списка акционеров у регистратора](../business-processes/meetings/shareholders-list-request.md) — бизнес-процесс
