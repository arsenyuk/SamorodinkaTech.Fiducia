...
Устав является учредительным документом акционерного общества и его требования обязательны для исполнения всеми органами общества и его акционерами **(п. 2 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md))**. В уставе должны содержаться следующие сведения:
...
- порядок подготовки и проведения общего собрания акционеров **(п. 3 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md))**.
...
- без проведения заседания (заочное голосование) **(п. 1 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-50-1.md))**.
...
- акционеров (акционера), являющихся владельцами не менее **10 процентов** голосующих акций общества на дату предъявления требования **(п. 1 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.

**Сроки проведения** внеочередного собрания:

- в течение **40 дней** с момента представления требования (общий случай);
- в течение **75 дней**, если повестка содержит вопрос об избрании совета директоров **(п. 2 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.

**Рассмотрение требования** о созыве ВОСА осуществляется советом директоров в течение **пяти рабочих дней** с даты его предъявления **(п. 3 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.

Если совет директоров в установленный срок не принял решение о созыве или принял решение об отказе, лица, требующие созыва, вправе обратиться в суд с требованием о понуждении общества провести внеочередное общее собрание акционеров **(п. 8 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.
...
**Срок:** Внеочередное собрание должно быть проведено в течение **75 дней** с момента возникновения основания **(п. 2 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.

**Бездействие:** Если оставшиеся члены совета директоров не исполняют эту обязанность, акционеры, владеющие не менее **10%** голосующих акций, вправе самостоятельно инициировать созыв внеочередного собрания **(п. 1 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**. Бездействие также влечет административную ответственность по **ст. 15.23.1 КоАП РФ**.
...
**Механизм преодоления:** Акционеры, владеющие не менее **10%** голосующих акций, вправе самостоятельно инициировать созыв внеочередного общего собрания акционеров, направляя требование **непосредственно в общество** (исполнительному органу, минуя совет директоров) **(п. 1, 8 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.

**Срок:** Общество обязано провести собрание в течение **40 дней** (или **70 дней**, если повестка содержит вопрос об избрании совета директоров) **(п. 2 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.
...
Общее собрание акционеров правомочно принимать решения, если в нем приняли участие акционеры, обладающие **более чем половиной голосов** размещенных голосующих акций общества **(п. 1 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-58.md))**.

**При отсутствии кворума** **(п. 4 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-58.md))**:
...
**Кворум для повторного заседания** составляет **не менее 30%** голосов размещенных голосующих акций общества. Уставом общества с числом акционеров более 500 тысяч может быть предусмотрен меньший кворум **(п. 4 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-58.md))**.
...
- При бездействии совета директоров акционеры с **10%** акций вправе требовать созыва внеочередного общего собрания акционеров **(п. 1 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md))**.
...
- Устав должен содержать сведения о ревизионной комиссии в случае принятия решения о ее создании **(п. 3 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md))**.
...
- Уставом могут быть установлены ограничения количества акций, принадлежащих одному акционеру, и максимального числа голосов, предоставляемых одному акционеру **(п. 3 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md))**.
...
- Устав может содержать сведения об отсутствии ревизионной комиссии **(п. 3 [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md))**.
...
|---|---|
| Устав как учредительный документ | [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-11.md) |
| Высший орган управления — общее собрание | ст. 47 Закона об АО |
| Компетенция общего собрания | ст. 48 Закона об АО |
| Внеочередное собрание | [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-55.md) |
| Кворум общего собрания | [ст. 11](../laws/article-11.md) Закона об АО(../laws/article-58.md) |
