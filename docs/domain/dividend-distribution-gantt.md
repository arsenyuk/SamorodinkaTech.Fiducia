...
| 13 | Выплата дивидендов номинальным держателям / доверительным управляющим — профессиональным участникам рынка ценных бумаг | Регистратор | **Не более 10 раб. дн. с даты определения лиц** | Задача | 12 |
| 14 | Выплата дивидендов другим зарегистрированным лицам | Регистратор | **Не более 25 раб. дн. с даты определения лиц** | Задача | 12 |
...
gantt
    ...
    Выплата номинальным держателям (до 10 раб. дн.) :s13, after s12, 10d
    Выплата другим лицам (до 25 раб. дн.)          :s14, after s12, 25d
...
### 7.1. Таблица для диаграммы Ганта

| № | Элемент | Ответственный | Срок | Тип | Зависимость |
|---|---------|---------------|------|-----|-------------|
| **0** | **Решение ОСУ о выплате дивидендов принято, протокол подписан** | — | День 0 | 🔷 **Стартовый сигнал** | — |
| 1 | Определение состава участников, имеющих право на дивиденды | Гендиректор | По внутреннему регламенту | Задача | 0 |
| 2 | Подготовка приказа ГД об осуществлении выплаты дивидендов | Гендиректор / финансовая служба | По внутреннему регламенту | Задача | 1 |
| **3** | **Приказ ГД подписан** | Генеральный директор | — | 🔶 **Веха** | 2 |
| 4 | Подготовка платежных поручений для выплаты участникам | Финансовая служба | По внутреннему регламенту | Задача | 3 |
| 5 | Перечисление денежных средств участникам | Финансовая служба | В пределах **60 кал.дн.** со дня решения (ст. 28 14-ФЗ) | Задача | 4 |
| **6** | **Выплата дивидендов завершена** | — | — | 🔶 **Веха** | 5 |
| **⚡КВ1** | **Выплата дивидендов — дедлайн** | — | **60 кал. дн. со дня решения** | ⚡ **Контрактная веха** | — |
...
### 7.2. Юридические основания (ООО)

| Норма | Содержание |
|-------|-----------|
| [ст. 28 14-ФЗ](../laws/article-14fz-26.md) | Порядок выплаты дивидендов: срок не более 60 дней со дня принятия решения |
| [ст. 29 14-ФЗ](../laws/article-14fz-26.md) | Ограничения выплаты дивидендов (непокрытый убыток, задолженность по взносам) |
