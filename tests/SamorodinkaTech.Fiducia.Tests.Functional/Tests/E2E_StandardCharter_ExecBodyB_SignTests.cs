...
/// ExecutiveBody B (участники = ЕИО) + подтверждение Подписание участниками (SIGN).
/// Уставы 25–30 (entityIndex 25–30).
...
public class E2E_StandardCharter_ExecBodyB_SignTests : BrowserFixture
{
    public E2E_StandardCharter_ExecBodyB_SignTests(GlobalFixture globalFixture) : base(globalFixture)
    {
    }

    // ── Уставы 25–30 (ExecutiveBody B: участники = ЕИО, SIGN) ───────
