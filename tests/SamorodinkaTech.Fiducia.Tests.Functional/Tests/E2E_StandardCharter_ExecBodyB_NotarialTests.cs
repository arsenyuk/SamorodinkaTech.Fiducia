...
/// ExecutiveBody B (участники = ЕИО) + подтверждение Нотариальное (NOTARIAL).
/// Уставы 07–12 (entityIndex 7–12).
...
public class E2E_StandardCharter_ExecBodyB_NotarialTests : BrowserFixture
{
    public E2E_StandardCharter_ExecBodyB_NotarialTests(GlobalFixture globalFixture) : base(globalFixture)
    {
    }

    // ── Уставы 07–12 (ExecutiveBody B: участники = ЕИО, NOTARIAL) ───
