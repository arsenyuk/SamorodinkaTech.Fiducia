...
/// ExecutiveBody A (ГД отдельно) + подтверждение Подписание участниками (SIGN).
/// Уставы 19–24 (entityIndex 19–24).
...
public class E2E_StandardCharter_ExecBodyA_SignTests : BrowserFixture
{
    public E2E_StandardCharter_ExecBodyA_SignTests(GlobalFixture globalFixture) : base(globalFixture)
    {
    }

    // ── Уставы 19–24 (ExecutiveBody A: ГД + участники, SIGN) ────────
