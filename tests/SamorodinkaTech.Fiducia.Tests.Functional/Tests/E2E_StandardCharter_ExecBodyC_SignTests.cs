...
/// ExecutiveBody C (участники = ЕИО совместно) + подтверждение Подписание участниками (SIGN).
/// Уставы 31–36 (entityIndex 31–36).
...
public class E2E_StandardCharter_ExecBodyC_SignTests : BrowserFixture
{
    public E2E_StandardCharter_ExecBodyC_SignTests(GlobalFixture globalFixture) : base(globalFixture)
    {
    }

    // ── Уставы 31–36 (ExecutiveBody C: участники = ЕИО совместно, SIGN) ──────
