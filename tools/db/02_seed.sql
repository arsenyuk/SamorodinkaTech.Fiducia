...
INSERT INTO ref_request_type(id, code, name, is_for_llc, is_for_njsc, is_for_pjsc, requires_file, considered_by_osu, created_at) VALUES
    ...
    ('a1000000-0000-0000-0000-000000000009','CONVERT_STANDARD_TO_CUSTOM_CHARTER','Требование изменить типовой устав на нетиповой',TRUE,FALSE,FALSE,TRUE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000010','CHANGE_CUSTOM_CHARTER_PROVISION','Требование изменить положение нетипового устава',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
