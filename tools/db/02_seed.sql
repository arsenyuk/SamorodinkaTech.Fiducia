...
INSERT INTO ref_notification_type (id, code, name, created_at, created_by) VALUES
    ('nn000001-0000-0000-0000-000000000001','MEETING_SUMMONS','Созыв заседания СД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000002','VOTE_REMINDER','Напоминание о голосовании',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000003','PROTOCOL_SIGNED','Протокол подписан',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000004','COMMITTEE_PROTOCOL_SIGNED','Протокол комитета подписан',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000005','VOTE_DEADLINE','Завершение голосования',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000006','CHAIRMAN_NOMINATION','Сбор кандидатур — Председатель СД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000007','DEPUTY_CHAIRMAN_NOMINATION','Сбор кандидатур — Зам. председателя СД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000008','CHAIRMAN_CONSENT','Согласие на должность Председателя СД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000009','DEPUTY_CHAIRMAN_CONSENT','Согласие на должность Зам. председателя СД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000010','GENERAL','Общее уведомление',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000011','COLLECTIVE_DEMAND_THRESHOLD','Коллективное требование — порог достигнут',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000012','COLLECTIVE_DEMAND_DECISION','Коллективное требование — решение ГД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000013','SHARE_REQUEST_ACCEPTED','Требование принято ГД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('nn000001-0000-0000-0000-000000000014','SHARE_REQUEST_VISIBLE_TO_ALL','Новое требование — видно всем ГД',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000')
ON CONFLICT (code) DO NOTHING;
