...
INSERT INTO ref_roles (id, code, name, created_at, created_by, is_assignable) VALUES
    ...
    ('99999999-9999-9999-9999-999999999999','PARTICIPANT','Участник',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000',FALSE),
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaad4','CEO','Генеральный директор',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000',FALSE),
...
INSERT INTO ref_notification_type (id, code, name, category, created_at, created_by) VALUES
    ...
    ('aa000001-0000-0000-0000-000000000002','VOTE_REMINDER','Напоминание о голосовании','OSA',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000003','PROTOCOL_SIGNED','Протокол подписан','OSA',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000004','COMMITTEE_PROTOCOL_SIGNED','Протокол комитета подписан','SD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000005','VOTE_DEADLINE','Завершение голосования','OSA',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000006','CHAIRMAN_NOMINATION','Сбор кандидатур — Председатель СД','SD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000007','DEPUTY_CHAIRMAN_NOMINATION','Сбор кандидатур — Зам. председателя СД','SD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000008','CHAIRMAN_CONSENT','Согласие на должность Председателя СД','SD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000009','DEPUTY_CHAIRMAN_CONSENT','Согласие на должность Зам. председателя СД','SD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000010','GENERAL','Общее уведомление','SYSTEM',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000011','COLLECTIVE_DEMAND_THRESHOLD','Коллективное требование — порог достигнут','UCHASTNIK',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000012','COLLECTIVE_DEMAND_DECISION','Коллективное требование — решение ГД','GD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000013','SHARE_REQUEST_ACCEPTED','Требование принято ГД','GD',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
    ('aa000001-0000-0000-0000-000000000014','SHARE_REQUEST_VISIBLE_TO_ALL','Новое требование — видно всем ГД','UCHASTNIK',CURRENT_TIMESTAMP,'00000000-0000-0000-0000-000000000000'),
...
INSERT INTO notification_template (id, notification_type_code, title_template, body_template, description, is_enabled) VALUES
    ('bb000001-0000-0000-0000-000000000001','MEETING_SUMMONS',
     'Созыв заседания совета директоров №{meetingNumber}',
     'Уведомляем вас о созыве {formText} заседания совета директоров №{meetingNumber}.{votingLine}\nОзнакомьтесь с повесткой и материалами к заседанию.',
     'Созыв заседания СД (очное/заочное/смешанное)', TRUE),
    ('bb000001-0000-0000-0000-000000000002','VOTE_REMINDER',
     'Напоминание о голосовании — заседание №{meetingNumber}',
     'Напоминаем о необходимости проголосовать по вопросам повестки заседания №{meetingNumber}. Голосование завершается {deadline} (МСК).',
     'Напоминание о голосовании', TRUE),
    ('bb000001-0000-0000-0000-000000000003','PROTOCOL_SIGNED',
     'Протокол подписан — заседание №{meetingNumber}',
     'Протокол заседания совета директоров №{meetingNumber} подписан. Документ доступен в разделе «Документы».',
     'Протокол заседания СД подписан', TRUE),
    ('bb000001-0000-0000-0000-000000000004','COMMITTEE_PROTOCOL_SIGNED',
     'Протокол подписан — {committeeName}',
     'Протокол №{protocolNumber} комитета «{committeeDisplayName}» подписан. Документ доступен в разделе «Документы».',
     'Протокол заседания комитета подписан', TRUE),
    ('bb000001-0000-0000-0000-000000000005','VOTE_DEADLINE',
     'Завершение голосования — заседание №{meetingNumber}',
     'Голосование по вопросам повестки заседания №{meetingNumber} завершено. Результаты будут отражены в протоколе заседания.',
     'Завершение голосования', TRUE),
    ('bb000001-0000-0000-0000-000000000006','CHAIRMAN_NOMINATION',
     'Сбор предложений кандидатур — Председатель СД {legalEntityName}',
     'Уважаемый член совета директоров!\n\nВ рамках подготовки к первому заседанию совета директоров {legalEntityName} просим вас направить предложения по кандидатурам на должность Председателя совета директоров.\n\nПредложения принимаются до даты, установленной внутренними документами Организации.\n\nС уважением,\nСекретарь совета директоров {legalEntityName}',
     'Сбор кандидатур на должность Председателя СД', TRUE),
    ('bb000001-0000-0000-0000-000000000007','DEPUTY_CHAIRMAN_NOMINATION',
     'Сбор предложений кандидатур — Заместитель председателя СД {legalEntityName}',
     'Уважаемый член совета директоров!\n\nВ рамках подготовки к первому заседанию совета директоров {legalEntityName} просим вас направить предложения по кандидатурам на должность Заместителя председателя совета директоров.\n\nПредложения принимаются до даты, установленной внутренними документами Организации.\n\nС уважением,\nСекретарь совета директоров {legalEntityName}',
     'Сбор кандидатур на должность Зам. председателя СД', TRUE),
    ('bb000001-0000-0000-0000-000000000008','CHAIRMAN_CONSENT',
     'ИМИТАЦИЯ ОТПРАВКА ПО email — Согласие на должность Председателя СД {legalEntityName}',
     'Уважаемый {candidateName}!\n\nВаша кандидатура предложена на должность Председателя совета директоров {legalEntityName}. Для включения в бюллетень голосования необходимо подписать согласие на выдвижение.\n\nПодписание согласия равнозначно собственноручной подписи в соответствии с Федеральным законом № 63-ФЗ.\n\nС уважением,\nСекретарь совета директоров {legalEntityName}',
     'Запрос согласия на должность Председателя СД', TRUE),
    ('bb000001-0000-0000-0000-000000000009','DEPUTY_CHAIRMAN_CONSENT',
     'ИМИТАЦИЯ ОТПРАВКА ПО email — Согласие на должность Заместителя председателя СД {legalEntityName}',
     'Уважаемый {candidateName}!\n\nВаша кандидатура предложена на должность Заместителя председателя совета директоров {legalEntityName}. Для включения в бюллетень голосования необходимо подписать согласие на выдвижение.\n\nПодписание согласия равнозначно собственноручной подписи в соответствии с Федеральным законом № 63-ФЗ.\n\nС уважением,\nСекретарь совета директоров {legalEntityName}',
     'Запрос согласия на должность Зам. председателя СД', TRUE),
    ('bb000001-0000-0000-0000-000000000010','GENERAL',
     'Общее уведомление',
     '{body}',
     'Общее уведомление (текст задаётся вызывающим кодом)', TRUE),
    ('bb000001-0000-0000-0000-000000000011','COLLECTIVE_DEMAND_THRESHOLD',
     'Коллективное требование — порог достигнут',
     'Порог коллективного требования достигнут. Требование направлено Генеральному директору.',
     'Порог коллективного требования достигнут', TRUE),
    ('bb000001-0000-0000-0000-000000000012','COLLECTIVE_DEMAND_DECISION',
     'Коллективное требование — решение ГД',
     'Генеральный директор принял решение по коллективному требованию.',
     'Решение ГД по коллективному требованию', TRUE),
    ('bb000001-0000-0000-0000-000000000013','SHARE_REQUEST_ACCEPTED',
     ...
     'Требование участника принято ГД', TRUE),
...
INSERT INTO ref_request_type(id, code, name, is_for_llc, is_for_njsc, is_for_pjsc, requires_file, considered_by_osu, created_at) VALUES
    ('a1000000-0000-0000-0000-000000000001','PREEMPTIVE_LIST','Запрос списка участников с правом выкупа',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000002','NOTARIAL_OFFER','Нотариальная оферта',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000003','EXIT_APPLICATION','Заявление о выходе из ООО',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000004','MANDATORY_BUYBACK','Обязательный выкуп доли',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000005','NOTARY_LIST_MAINTENANCE','Ведение списка участников через нотариат',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000006','CONVERT_TO_NJSC','Требование преобразовать ООО в НАО',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000007','CONVERT_TO_PJSC','Требование преобразовать НАО в ПАО',FALSE,TRUE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000008','CHANGE_STANDARD_CHARTER_NUMBER','Требование изменить номер типового устава',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000009','CONVERT_STANDARD_TO_CUSTOM_CHARTER','Требование изменить типовой устав на индивидуальный',TRUE,FALSE,FALSE,TRUE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000010','CHANGE_CUSTOM_CHARTER_PROVISION','Требование изменить положение индивидуального устава',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000011','CHANGE_CHARTER_PROVISION','Требование изменить положение устава',FALSE,TRUE,TRUE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000012','DEMAND_VOSU','Требование о созыве ВОСУ',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000013','ADD_AGENDA_OSU','Требование включить вопрос в повестку ОСУ',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000014','REQUEST_INFORMATION','Требование о предоставлении информации',TRUE,FALSE,FALSE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000015','EXCLUDE_PARTICIPANT','Требование об исключении участника',TRUE,FALSE,FALSE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000016','DEMAND_VOSA','Требование о созыве ВОСА',FALSE,TRUE,TRUE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000017','ADD_AGENDA_GOSA','Требование включить вопрос в повестку ГОСА',FALSE,TRUE,TRUE,FALSE,TRUE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000018','DEMAND_INFO_AO','Требование о предоставлении информации (АО)',FALSE,TRUE,TRUE,FALSE,FALSE,CURRENT_TIMESTAMP),
    ('a1000000-0000-0000-0000-000000000019','OTHER','Другое',TRUE,TRUE,TRUE,FALSE,FALSE,CURRENT_TIMESTAMP)
ON CONFLICT (code) DO NOTHING;

-- Справочник: ref_document_type (типы документов для требования)
INSERT INTO ref_document_type(id, code, name, group_code, group_name, is_electronic_available, is_unitary, storage_years, is_for_llc, is_for_njsc, is_for_pjsc, sort_order, created_at) VALUES
    -- Учредительные документы
    ('b1000000-0000-0000-0000-000000000001','CHARTER','Устав','FOUNDING','Учредительные документы',TRUE,TRUE,3,TRUE,FALSE,FALSE,1,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000002','FOUNDING_DOCUMENT','Договор об учреждении общества','FOUNDING','Учредительные документы',TRUE,TRUE,3,TRUE,FALSE,FALSE,2,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000003','CREATION_DECISION','Решение о создании общества','FOUNDING','Учредительные документы',TRUE,TRUE,3,TRUE,FALSE,FALSE,3,CURRENT_TIMESTAMP),
    -- Документы об имуществе и структуре
    ('b1000000-0000-0000-0000-000000000004','PARTICIPANT_REGISTER','Реестр участников','PROPERTY','Документы об имуществе и структуре',TRUE,FALSE,3,TRUE,FALSE,FALSE,4,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000014','BRANCH_REGULATIONS','Положения о филиалах и представительствах','PROPERTY','Документы об имуществе и структуре',TRUE,FALSE,3,TRUE,FALSE,FALSE,14,CURRENT_TIMESTAMP),
    -- Протоколы и списки
    ('b1000000-0000-0000-0000-000000000005','PROTOCOL_OSU','Протоколы общих собраний участников','PROTOCOLS','Протоколы и списки',TRUE,FALSE,3,TRUE,FALSE,FALSE,5,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000006','PROTOCOL_BOD','Протоколы заседаний Совета директоров','PROTOCOLS','Протоколы и списки',TRUE,FALSE,3,TRUE,FALSE,FALSE,6,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000008','AFFILIATED_PERSONS','Списки аффилированных лиц','PROTOCOLS','Протоколы и списки',TRUE,FALSE,3,TRUE,FALSE,FALSE,8,CURRENT_TIMESTAMP),
    -- Финансовая документация
    ('b1000000-0000-0000-0000-000000000007','ACCOUNTING_DOCUMENTS','Документы бухгалтерского учёта','FINANCIAL','Финансовая документация',FALSE,FALSE,3,TRUE,FALSE,FALSE,7,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000012','ANNUAL_REPORT','Годовой отчёт','FINANCIAL','Финансовая документация',TRUE,FALSE,3,TRUE,FALSE,FALSE,12,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000013','FINANCIAL_STATEMENTS','Бухгалтерская (финансовая) отчётность','FINANCIAL','Финансовая документация',FALSE,FALSE,5,TRUE,FALSE,FALSE,13,CURRENT_TIMESTAMP),
    -- Документы по сделкам
    ('b1000000-0000-0000-0000-000000000009','MAJOR_TRANSACTIONS','Документы крупных сделок','TRANSACTIONS','Документы по сделкам',FALSE,FALSE,5,TRUE,FALSE,FALSE,9,CURRENT_TIMESTAMP),
    ('b1000000-0000-0000-0000-000000000010','RELATED_PARTY_TRANSACTIONS','Сделки с заинтересованностью','TRANSACTIONS','Документы по сделкам',FALSE,FALSE,5,TRUE,FALSE,FALSE,10,CURRENT_TIMESTAMP),
    -- Внутренние документы
    ('b1000000-0000-0000-0000-000000000011','INTERNAL_DOCUMENTS','Внутренние документы (положения, регламенты)','INTERNAL','Внутренние документы',FALSE,FALSE,3,TRUE,FALSE,FALSE,11,CURRENT_TIMESTAMP)
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO ref_document_access_method(id, code, name, description, deadline_days, sort_order, created_at) VALUES
    ('c1000000-0000-0000-0000-000000000001','IN_PERSON','Ознакомление в офисе','Участник допускается к ознакомлению с документами в помещении исполнительного органа общества',5,1,CURRENT_TIMESTAMP),
    ('c1000000-0000-0000-0000-000000000002','COPIES_ISSUE','Заверенная копия','Общество выдаёт участнику заверенные копии документов. Плата не может превышать затраты на изготовление',NULL,2,CURRENT_TIMESTAMP),
    ('c1000000-0000-0000-0000-000000000003','ELECTRONIC_COPY','Электронный документ','Общество предоставляет электронные копии документов в формате PDF',NULL,3,CURRENT_TIMESTAMP)
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO ref_standard_charter (id, number, exit_allowed, transfer_to_participants_without_consent, transfer_to_third_parties_without_consent, preemptive_right, inheritance_without_consent, executive_body, protocol_confirmation_method_id, created_at, created_by) VALUES
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04', '04', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'A', 'bbbb0000-0000-0000-0000-000000000001', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee10', '10', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'B', 'bbbb0000-0000-0000-0000-000000000001', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee16', '16', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'C', 'bbbb0000-0000-0000-0000-000000000001', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee22', '22', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'A', 'bbbb0000-0000-0000-0000-000000000002', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee28', '28', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'B', 'bbbb0000-0000-0000-0000-000000000002', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeee34', '34', FALSE, TRUE,  TRUE,  FALSE, TRUE, 'C', 'bbbb0000-0000-0000-0000-000000000002', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'),
...
-- Системные настройки
-- ============================================================================
INSERT INTO system_settings (id, key, value, description, validation_type, created_by, created_at) VALUES
    ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'gantt_end_padding_weeks', '2', 'Запас в неделях после окончания последней задачи на диаграмме Ганта', 'non_negative_int', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP),
    ...
    ('ffffffff-ffff-ffff-ffff-fffffffffff7', 'osu_protocol_deadline_days', '3', 'Срок составления протокола ОСУ (дней). Ст. 37 п. 6 14-ФЗ', 'positive_int', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP),
    ('ffffffff-ffff-ffff-ffff-fffffffffff8', 'osa_protocol_deadline_days', '3', 'Срок составления протокола ОСА (дней). Ст. 68 п. 4 208-ФЗ', 'positive_int', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP),
    ('ffffffff-ffff-ffff-ffff-fffffffffff9', 'osu_board_protocol_deadline_days', '3', 'Срок составления протокола заседания СД (ООО) (дней). Ст. 32 п. 3.2 14-ФЗ', 'positive_int', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP),
    ('ffffffff-ffff-ffff-ffff-fffffffffffA', 'osa_board_protocol_deadline_days', '3', 'Срок составления протокола заседания СД (АО) (дней). Ст. 65 208-ФЗ', 'positive_int', '00000000-0000-0000-0000-000000000000', CURRENT_TIMESTAMP)
