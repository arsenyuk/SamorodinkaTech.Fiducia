...
INSERT INTO ext_spark_founder (id, inn, name, founder_inn, founder_ogrn, country, is_foreign,
    ...
    entry_date, exit_date, director_count, fetched_at)
VALUES
    -- ЮЛ-учредитель: холдинговая компания
    (gen_random_uuid(), '7721546864',
     'Общество с ограниченной ответственностью «ВБ Холдинг»', '7721999001', '1247700012345',
     'Россия', FALSE,
     NULL, NULL, NULL,
     750000.00, 75.00,
     '2020-03-15', NULL, NULL, NOW()),
    -- Действующий ФЛ-учредитель
    (gen_random_uuid(), '7721546864',
     NULL, NULL, NULL, NULL, FALSE,
     'Бакальчук Татьяна Владимировна', '501201234567', 'Россия',
     200000.00, 20.00,
     '2004-04-20', NULL, 1, NOW()),
    -- Действующий ФЛ-учредитель (миноритарий)
    (gen_random_uuid(), '7721546864',
     NULL, NULL, NULL, NULL, FALSE,
     'Бакальчук Владислав Сергеевич', '501208765432', 'Россия',
     10000.00, 1.00,
     '2004-04-20', NULL, 0, NOW()),
    -- Выбывший сооснователь: продал долю холдингу в 2019
    (gen_random_uuid(), '7721546864',
     NULL, NULL, NULL, NULL, FALSE,
     'Ревякин Сергей Владимирович', '501209876543', 'Россия',
     150000.00, 15.00,
     '2004-04-20', '2019-06-30', 3, NOW());
